...
interface ManagerBranchFormProps {
  branch?: Branch;
}

export const ManagerBranchForm = ({ branch }: ManagerBranchFormProps) => {
    ...
    <ScrollView className="flex-1 m-3 gap-3">
      ...
      <FormProvider {...formMethods}>
        <FormContainer>
          ...
          <FormGroup name="name" label="Branch Name" placeholder="Branch name" readOnly />
          <FormRow>
            <View style={{ flex: 1 }}>
          ...
          <FormGroup type="list" label="Managers" name="managerIds" options={managerOptions} optional readOnly />
          <FormGroup type="list" label="Retailers" name="retailerIds" options={retailerOptions} optional readOnly />

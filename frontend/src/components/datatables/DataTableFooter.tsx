...
export const DataTableFooter = ({ 
  ...
  const end = (start - 1) + size >= total ? total : (start - 1) + size;
  return (
    <View className="flex-row items-center justify-end p-3 w-full rounded-b-lg border-t border-slate-300 bg-slate-200">

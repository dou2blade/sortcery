...
export const publicKeys = {
  ...
  branch: (id: number, latitude: number, longitude: number) => [...publicKeys.branches(), id, latitude, longitude] as const,
  branchesStore: (search: string, id: number, latitude: number, longitude: number) => [...publicKeys.branches(), "store", id, search, latitude, longitude] as const,
  ...
  productsAlternatives: (id: number, latitude: number, longitude: number) => [...publicKeys.products(), "alternatives", id, latitude, longitude] as const,
